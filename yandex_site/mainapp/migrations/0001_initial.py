    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_name', models.CharField(max_length=255, null=True, verbose_name='название ЖК')),
                ...
                ('distance_nearest_metro', models.CharField(max_length=25, null=True, verbose_name='Расстояние до ближайшей станции')),
                ('distance_nearest_ground_transport', models.CharField(max_length=25, null=True, verbose_name='Расстояние до ближайшей остановки наземного транспорта')),
